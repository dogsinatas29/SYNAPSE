# <img src="./resources/synapse-icon.png" width="40" height="40" /> 🧠 SYNAPSE: Visual Architecture Engine (v0.3.22)
...
## 🔥 Latest Release: v0.3.22 - Rendering Parity & Intelligent Tooltips (2026-04-20)

| Feature | Description | Benefit |
|-------|---------|-----|
| **Rendering Parity** | **Full 2D/3D Sync** | Synchronized WebGL colors (RGBA), shapes, and borders with the 2D engine for seamless mode switching. |
| **Senior's Tooltip** | **Diagnostic Intelligence** | 100ms debounced tooltips with identity binding, icons (📄, ⚡), and LOD-aware rendering. |
| **Engine Hardening** | **Zero-Crash ID Match** | Robust stem-based ID extraction prevents engine blackouts and null-pointer exceptions. |
| **Visual Depth** | **High-Contrast Contours** | Thickened shader borders and premium shadows for superior architectural clarity. |
| **Identity Rescue** | **Robust Mapping** | Eliminates "Unknown" tags via dual-match (Exact/Stem) logic and automated identity recovery. |

---

## 🔥 v0.3.21 - Visual Consistency & Edge Bundling (2026-04-18)
...
![Flow View](./screenshots/v0.2.21/flow_view.png)
...
```
Current Version: **v0.3.22** (Rendering Parity & Intelligent Tooltips)
...
1. **Install Extension**: Install the `synapse-visual-architecture-v0.3.22.vsix` (or latest).
...
| :--- | :--- | :--- | :--- |
| **v0.3.22** | 2026-04-20 | **Rendering Parity & Intelligent Tooltips**: Full 2D/3D visual synchronization, debounced tooltips with identity binding, and LOD-aware lists. | **렌더링 동기화 및 지능형 툴팁**: 2D/3D 시각적 완전 동기화, 정체성 바인딩이 적용된 데바운스 툴팁 및 LOD 대응 리스트 도입. |
