...
| :---: | :---: | :--- |
| **v0.3.33.1** | 2026-07-15 | **Aesthetics & LOD Optimization**: Fixed "Roots Only" cluster visibility bug to properly render depth-1 Continents as collapsed blocks while maintaining depth-0 roots expanded. Implemented 3-level Edge LOD (FULL/CLUSTER/NONE) to eliminate premature edge-culling on massive mono-repos. Refactored trackpad zoom logic with non-linear DeltaY sensitivity to fix hypersensitive "microscope" scrolling. |
