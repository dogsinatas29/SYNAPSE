...
`;
        ...
        try {
            ...
            expect(summary.references).toContainEqual({ target: 'MyHeader', type: 'dependency', isApproved: true, nodeId: undefined });
        } finally {
    ...
    it('should correctly extract structs and functions from Rust files', () => {
        ...
        try {
            ...
            expect(summary.references).toContainEqual({ target: 'models', type: 'dependency', isApproved: true, nodeId: undefined });
        } finally {
