...
- **Origin Edge**: Referenced files in your prompt (e.g., `[src/main.ts](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/src/main.ts)`) are visualized as **Origin Edges** on the canvas, showing the "Cause & Effect" of your decisions.
...
- **Korean Support**: Added [`README.ko.md`](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/README.ko.md) for Korean users.
- **English Support**: Refined [`README.md`](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/README.md).
