...
[🇰🇷 한국어 (Korean)](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/README.ko.md) | [🇺🇸 English (English)](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/README.md)
...
![Graph View](https://github.com/dogsinatas29/SYNAPSE/raw/HEAD/docs/media/synapse_graph_view.png)

### 🌳 Tree View
Intuitively overview the project's folder structure and file hierarchy.
![Tree View](https://github.com/dogsinatas29/SYNAPSE/raw/HEAD/docs/media/synapse_tree_view.png)

### ➡️ Flow View
Projects the logic execution flow of a specific event or function into a linear flowchart.
![Flow View](https://github.com/dogsinatas29/SYNAPSE/raw/HEAD/docs/media/synapse_flow_view.png)
...
This project is licensed under the [GNU General Public License v3.0](https://github.com/dogsinatas29/SYNAPSE/blob/HEAD/LICENSE).
